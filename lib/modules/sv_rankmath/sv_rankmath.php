<?php
	...
	class sv_rankmath extends modules {
		public function init() {
			// Section Info
			$this->set_section_title( __( 'Rankmath', 'sv100_companion' ) )
				->set_section_desc( __( 'Tweaks for Rankmath', 'sv100_companion' ) )
		...
		public function load_settings(): sv_rankmath{
		...
		protected function register_scripts(): sv_rankmath {
			// Register Styles
		...
		public function faq_block_accordion(): sv_rankmath{
			if(!$this->has_block_frontend('rank-math/faq-block')){
				return $this;
			}
